...
void http_parse_ua(struct _p0fhdlr *hdlr, u8* val, u32 line_no);

void http_register_sig(struct _p0fhdlr *hdlr, u8 to_srv, u8 generic, s32 sig_class, u32 sig_name,
                       u8* sig_flavor, u32 label_id, u32* sys, u32 sys_cnt,
                       u8* val, u32 line_no);

u8 process_http(struct _p0fhdlr *hdlr, u8 to_srv, struct packet_flow* f);

void free_sig_hdrs(struct http_sig* h);

void p0f_http_init(struct _p0fhdlr *hdlr);
