...
struct packet_flow {
  ...
  u8 is_active;                         /* Active flow is flow that comes with a valid 3-ways handshake */
...
struct host_data* lookup_host(struct _p0fhdlr *hdlr, u8* addr, u8 ip_ver);

void destroy_all_hosts(struct _p0fhdlr *hdlr);
