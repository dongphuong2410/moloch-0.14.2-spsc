...
int UUENCODE_object_init( struct UUENCODE_object *uo )
{
	uo->doubleCR_mode = 0;
	return 0;
}
...
\------------------------------------------------------------------*/
int UUENCODE_set_doubleCR_mode( struct UUENCODE_object *uo, int level )
{
	uo->doubleCR_mode = level;
	return uo->doubleCR_mode;
}
...
\------------------------------------------------------------------*/
int UUENCODE_decode_uu( FFGET_FILE *f, char *unpackdir, struct UUENCODE_object *uo, char *input_filename, char *out_filename, int out_filename_size, int decode_whole_file, int keep )
{
	...
	if (!f)
	{
		...
		FFGET_set_watch_SDL( uo->doubleCR_mode );
		finf = &ffinf;
