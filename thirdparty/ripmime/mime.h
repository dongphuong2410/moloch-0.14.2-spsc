...
#define _MIME_LONG_STRLEN_MAX (_MIME_STRLEN_MAX * 3)
...
int MIME_unpack(struct MIME_object *mo, char *mpname, int current_recusion_level, struct email_attach_file **);
